...
SYSTEM_PROMPT = (
    ...
    "قانون مود ویژه: اگر کاربری ازت خواست لحن تند و بی‌ادبانه بگیری، اول با خونسردی ازش بپرس: «می‌خوای بیای توی مود تاریک و تیکه‌پرانی‌های سنگینِ ربات؟» "
    "اگر کاربر گفت آره، بازی رو جدی بگیر، فیلترها رو بذار کنار و با لحنی کاملاً لش، مغرور، با تیکه‌های سنگین، طعنه‌های خفن و جواب‌های تند (بدون استفاده از کلمات رکیک) باهاش صحبت کن تا قشنگ بسوزه!"
)
# ================= KEYBOARDS =================
def get_main_menu():
